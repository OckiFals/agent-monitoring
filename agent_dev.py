...
class ClientProtocol(DatagramProtocol):
    def startProtocol(self):
        ...
        host = "127.0.0.1"
        self.transport.connect('127.0.0.1', 9982)
        mac = getmac()
...
def getNetwork():
    ...
    net = (type,getmac(),bytesent, byterecv, pktsent, pktrcv)
...
def getResource():
    ...
    res = (type,getmac(),cpu, memory, usedmem, swap)
...
def getDisk():
    ...
    disk=(type,getmac(),disk_used,disk_free,read_bytes,write_bytes)
